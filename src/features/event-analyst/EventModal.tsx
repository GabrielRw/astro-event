    ...
    const handleGeocode = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(locationLabel)}&limit=1`,
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <input
                                    ...
                                    className="flex-1 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-white placeholder-white/40 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/50"
                                />
                                <button
                                    type="button"
                                    onClick={handleGeocode}
                                    disabled={isGeocoding || !locationLabel.trim()}
